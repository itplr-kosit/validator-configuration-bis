...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="rsm:ExchangedDocumentContext" mode="M14" priority="1018">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:ApplicableHeaderTradeAgreement" mode="M14" priority="1017">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:ApplicableHeaderTradeSettlement" mode="M14" priority="1016">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:ExchangedDocument" mode="M14" priority="1015">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:BuyerTradeParty" mode="M14" priority="1014">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SellerTradeParty" mode="M14" priority="1013">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SpecifiedTradeAllowanceCharge[ram:CalculationPercent and not(ram:BasisAmount)]" mode="M14" priority="1012">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SpecifiedTradeAllowanceCharge[not(ram:CalculationPercent) and ram:BasisAmount]" mode="M14" priority="1011">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SpecifiedTradeAllowanceCharge" mode="M14" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:AppliedTradeAllowanceCharge" mode="M14" priority="1009">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="                 ram:SpecifiedTradeSettlementPaymentMeans[some $code in tokenize('49 59', '\s')                     satisfies normalize-space(ram:TypeCode) = $code]" mode="M14" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:SupplyChainTradeTransaction[ram:ApplicableHeaderTradeSettlement/ram:BillingSpecifiedPeriod/ram:StartDateTime]/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:BillingSpecifiedPeriod/ram:StartDateTime" mode="M14" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:SupplyChainTradeTransaction[ram:ApplicableHeaderTradeSettlement/ram:BillingSpecifiedPeriod/ram:EndDateTime]/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeSettlement/ram:BillingSpecifiedPeriod/ram:EndDateTime" mode="M14" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:IncludedSupplyChainTradeLineItem" mode="M14" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:NetPriceProductTradePrice | ram:GrossPriceProductTradePrice" mode="M14" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:NetPriceProductTradePrice/ram:BasisQuantity[@unitCode] | ram:GrossPriceProductTradePrice/ram:BasisQuantity[@unitCode]" mode="M14" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:URIID[@schemeID = '0088'] | ram:ID[@schemeID = '0088'] | ram:GlobalID[@schemeID = '0088']" mode="M14" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:URIID[@schemeID = '0192'] | ram:ID[@schemeID = '0192'] | ram:GlobalID[@schemeID = '0192']" mode="M14" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:URIID[@schemeID = '0184'] | ram:ID[@schemeID = '0184'] | ram:GlobalID[@schemeID = '0184']" mode="M14" priority="1000">
...
<xsl:variable name="DKSupplierCountry" select="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:PostalTradeAddress/ram:CountryID" />
  <xsl:variable name="DKCustomerCountry" select="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:PostalTradeAddress/ram:CountryID" />
	...
	<!--RULE -->
<xsl:template match="rsm:CrossIndustryInvoice[$DKSupplierCountry = 'DK']" mode="M16" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:CrossIndustryInvoice[$DKSupplierCountry = 'DK']/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:SpecifiedTaxRegistration" mode="M16" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:CrossIndustryInvoice[$DKSupplierCountry = 'DK' and $DKCustomerCountry = 'DK']/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans" mode="M16" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="rsm:CrossIndustryInvoice[$DKSupplierCountry = 'DK' and $DKCustomerCountry = 'DK']/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem" mode="M16" priority="1000">
...
<xsl:variable name="ISO3166" select="tokenize('AD AE AF AG AI AL AM AO AQ AR AS AT AU AW AX AZ BA BB BD BE BF BG BH BI BJ BL BM BN BO BQ BR BS BT BV BW BY BZ CA CC CD CF CG CH CI CK CL CM CN CO CR CU CV CW CX CY CZ DE DJ DK DM DO DZ EC EE EG EH ER ES ET FI FJ FK FM FO FR GA GB GD GE GF GG GH GI GL GM GN GP GQ GR GS GT GU GW GY HK HM HN HR HT HU ID IE IL IM IN IO IQ IR IS IT JE JM JO JP KE KG KH KI KM KN KP KR KW KY KZ LA LB LC LI LK LR LS LT LU LV LY MA MC MD ME MF MG MH MK ML MM MN MO MP MQ MR MS MT MU MV MW MX MY MZ NA NC NE NF NG NI NL NO NP NR NU NZ OM PA PE PF PG PH PK PL PM PN PR PS PT PW PY QA RE RO RS RU RW SA SB SC SD SE SG SH SI SJ SK SL SM SN SO SR SS ST SV SX SY SZ TC TD TF TG TH TJ TK TL TM TN TO TR TT TV TW TZ UA UG UM US UY UZ VA VC VE VG VI VN VU WF WS YE YT ZA ZM ZW', '\s')" />
  ...
  <xsl:variable name="eaid" select="tokenize('0002 0007 0009 0037 0060 0088 0096 0097 0106 0135 0142 0151 0183 0184 0190 0191 0192 0193 0195 0196 0198 0199 0200 0201 0202 9901 9902 9904 9905 9906 9907 9910 9913 9914 9915 9917 9918 9919 9920 9921 9922 9923 9924 9925 9926 9927 9928 9929 9930 9931 9932 9933 9934 9935 9936 9937 9938 9939 9940 9941 9942 9943 9944 9945 9946 9947 9948 9949 9950 9951 9952 9953 9955 9956 9957 9958', '\s')" />
	...
	<!--RULE -->
<xsl:template match="ram:AttachmentBinaryObject[@mimeCode]" mode="M19" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SpecifiedTradeAllowanceCharge[normalize-space(ram:ChargeIndicator/udt:Indicator) = 'false']/ram:ReasonCode" mode="M19" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ram:SpecifiedTradeAllowanceCharge[normalize-space(ram:ChargeIndicator/udt:Indicator) = 'true']/ram:ReasonCode" mode="M19" priority="1004">
